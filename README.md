...
Simple Marketing HQ is a PWA-first AI marketing advisor for small businesses, built with Next.js, TypeScript, Tailwind CSS, Supabase-ready helpers, and Vercel deployment defaults.
