...
const navItems: Utility[] = [
  ...
  },
  {
    ...
    shortTitle: "ICP",
    href: "/icp-builder",
    body: "Keep the current best-fit customer recommendation.",
    icon: <Target size={19} />,
  ...
  },
  {
    ...
    shortTitle: "Offer",
    href: "/offer-builder",
    body: "Keep the current offer, CTA, and proof point.",
    icon: <Rocket size={19} />,
  ...
  },
  {
    ...
    body: "Keep the current headline, pitch, and CTA.",
  ...
  },
  {
    ...
    shortTitle: "Content",
    href: "/content-engine",
    body: "Keep themes, hooks, posts, and email ideas ready.",
  ...
  },
  {
    ...
    shortTitle: "Strategy",
    href: "/strategy-map",
    body: "Choose what to build first and what to ignore.",
