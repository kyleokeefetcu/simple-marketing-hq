...
export const commandCenterModules = [
  ...
  },
  {
    ...
    title: "Audience HQ",
    href: "/icp-builder",
    body: "Maintain the current best-fit customer recommendation, buyer pain, trigger, objections, proof needed, and where to find them.",
  },
  {
    slug: "offer-builder",
    title: "Offer HQ",
    href: "/offer-builder",
    body: "Maintain the current recommended offer, CTA, proof point, buyer, problem, outcome, and improvement history.",
  },
  {
    slug: "message-builder",
    title: "Messaging HQ",
    href: "/message-builder",
    body: "Maintain the current headline, subheadline, CTA, short pitch, follow-up opener, and customer-facing language.",
  },
  {
    slug: "strategy-map",
    title: "Strategy Map",
