export const brand = {
  ...
  growthPlanName: "LaunchPad Growth Plan",
  actionPlanName: "LaunchPad Action Plan",
  advisorName: "LaunchPad Advisor",
  recommendationsName: "LaunchPad Recommendations",
};
